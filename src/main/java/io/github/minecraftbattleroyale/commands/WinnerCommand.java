...
public class WinnerCommand implements CommandExecutor {
    private static final String[] ALIAS = new String[] {"winner"};
    private static final CommandSpec COMMAND_SPEC = CommandSpec.builder()
            .description(Text.of("make you the winner"))
            .executor(new WinnerCommand())
            .build();
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        plugin.getCurrentGame().declareWinner(plugin.getCurrentGame().getPlayer(player));
